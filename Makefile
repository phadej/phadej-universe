project-files: cabal.7.4.2.project cabal.7.6.3.project cabal.7.8.4.project cabal.7.10.3.project cabal.8.0.2.project cabal.8.2.2.project cabal.8.4.4.project cabal.8.6.5.project cabal.8.8.4.project cabal.8.10.7.project cabal.9.0.2.project cabal.9.2.4.project cabal.9.4.1.project
Makefile: cabal.darkmatter
	darkmatter > Makefile
build: build-7.4.2 build-7.6.3 build-7.8.4 build-7.10.3 build-8.0.2 build-8.2.2 build-8.4.4 build-8.6.5 build-8.8.4 build-8.10.7 build-9.0.2 build-9.2.4 build-9.4.1
test: test-build test-7.4.2 test-7.6.3 test-7.8.4 test-7.10.3 test-8.0.2 test-8.2.2 test-8.4.4 test-8.6.5 test-8.8.4 test-8.10.7 test-9.0.2 test-9.2.4 test-9.4.1
test-build: test-dry test-build-7.4.2 test-build-7.6.3 test-build-7.8.4 test-build-7.10.3 test-build-8.0.2 test-build-8.2.2 test-build-8.4.4 test-build-8.6.5 test-build-8.8.4 test-build-8.10.7 test-build-9.0.2 test-build-9.2.4 test-build-9.4.1
test-dry: test-dry-7.4.2 test-dry-7.6.3 test-dry-7.8.4 test-dry-7.10.3 test-dry-8.0.2 test-dry-8.2.2 test-dry-8.4.4 test-dry-8.6.5 test-dry-8.8.4 test-dry-8.10.7 test-dry-9.0.2 test-dry-9.2.4 test-dry-9.4.1
deps: deps-7.4.2.png deps-7.6.3.png deps-7.8.4.png deps-7.10.3.png deps-8.0.2.png deps-8.2.2.png deps-8.4.4.png deps-8.6.5.png deps-8.8.4.png deps-8.10.7.png deps-9.0.2.png deps-9.2.4.png deps-9.4.1.png
...
build-9.2.4: cabal.9.2.4.project
	cabal new-build --builddir=dist-newstyle-9.2.4 --project-file cabal.9.2.4.project -w ghc-9.2.4 --disable-tests --disable-benchmarks all
build-9.4.1: cabal.9.4.1.project
	cabal new-build --builddir=dist-newstyle-9.4.1 --project-file cabal.9.4.1.project -w ghc-9.4.1 --disable-tests --disable-benchmarks all
...
cabal.9.0.2.project: cabal.darkmatter
	darkmatter
cabal.9.2.4.project: cabal.darkmatter
	darkmatter
cabal.9.4.1.project: cabal.darkmatter
	darkmatter
...
deps-9.2.4.png: cabal.9.2.4.project
	cabal new-build --builddir=dist-newstyle-9.2.4 --project-file cabal.9.2.4.project -w ghc-9.2.4 --disable-tests --disable-benchmarks all --dry-run
	cabal-plan --hide-builtin --hide-global dot --builddir=dist-newstyle-9.2.4 --tred --tred-weights | dot -Tpng -odeps-9.2.4.png
deps-9.4.1.png: cabal.9.4.1.project
	cabal new-build --builddir=dist-newstyle-9.4.1 --project-file cabal.9.4.1.project -w ghc-9.4.1 --disable-tests --disable-benchmarks all --dry-run
	cabal-plan --hide-builtin --hide-global dot --builddir=dist-newstyle-9.4.1 --tred --tred-weights | dot -Tpng -odeps-9.4.1.png
...
test-9.2.4: cabal.9.2.4.project test-build-9.2.4
	cabal new-test --builddir=dist-newstyle-9.2.4 --project-file cabal.9.2.4.project -w ghc-9.2.4 --enable-tests --enable-benchmarks all
test-9.4.1: cabal.9.4.1.project test-build-9.4.1
	cabal new-test --builddir=dist-newstyle-9.4.1 --project-file cabal.9.4.1.project -w ghc-9.4.1 --enable-tests --enable-benchmarks all
...
test-build-9.2.4: cabal.9.2.4.project test-dry-9.2.4
	cabal new-build --builddir=dist-newstyle-9.2.4 --project-file cabal.9.2.4.project -w ghc-9.2.4 --enable-tests --enable-benchmarks all
test-build-9.4.1: cabal.9.4.1.project test-dry-9.4.1
	cabal new-build --builddir=dist-newstyle-9.4.1 --project-file cabal.9.4.1.project -w ghc-9.4.1 --enable-tests --enable-benchmarks all
...
test-dry-9.2.4: cabal.9.2.4.project
	cabal new-build --builddir=dist-newstyle-9.2.4 --project-file cabal.9.2.4.project -w ghc-9.2.4 --enable-tests --enable-benchmarks --dry all
test-dry-9.4.1: cabal.9.4.1.project
	cabal new-build --builddir=dist-newstyle-9.4.1 --project-file cabal.9.4.1.project -w ghc-9.4.1 --enable-tests --enable-benchmarks --dry all
git-update:
